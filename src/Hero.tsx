    ...
    return (
        <section className='hero min-h-screen bg-cover pt-24'>
            ...
            <h4 className='p-2 font-medium text-white'>
                I'm a software developer with full-stack experience, especially
                in front-end development using Angular and React. With that
                said, I am still early in my career and am open-minded to areas
                outside of web development. I care about writing clean,
